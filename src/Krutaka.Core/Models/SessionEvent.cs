...
/// </summary>
/// <param name="Type">The event type (e.g., "user", "assistant", "tool_use", "tool_result", "compaction").</param>
...
/// <param name="TokensBefore">Token count before compaction (for "compaction" events only).</param>
/// <param name="TokensAfter">Token count after compaction (for "compaction" events only).</param>
/// <param name="MessagesRemoved">Number of messages removed during compaction (for "compaction" events only).</param>
...
public sealed record SessionEvent(
    ...
    [property: JsonPropertyName("tokens_before")] int? TokensBefore = null,
    [property: JsonPropertyName("tokens_after")] int? TokensAfter = null,
    [property: JsonPropertyName("messages_removed")] int? MessagesRemoved = null
);

...
7. **Deadman switch reset** — notify `SessionManager` of tool completion (via callback/event) so it can reset the inactivity timer. The orchestrator MUST NOT hold a direct reference to the timer.
